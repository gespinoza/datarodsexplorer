...
Key links: 
 ...
 - View the [DRE User Guide](https://github.com/gespinoza/datarodsexplorer/blob/master/docs/DREUserGuide.md)   (Update the `About` link in [app_base_dre.html](#https://github.com/gespinoza/datarodsexplorer/tethysapp/data_rods_explorer/templates/data_rods_explorer/app_base_dre.html) when this changes)
